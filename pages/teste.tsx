...
export async function getStaticProps() {
  //   const cardCollection = await loadCards(1, 3);
  //   const paramsTeste: PokemonTCG.Parameter = {
  //     q: `nationalPokedexNumbers:2`,
  //     pageSize: 1,
  //     orderBy: "-tcgplayer.prices.high",
  //   };

  //   const cardCollection = await PokemonTCG.findCardsByQueries(paramsTeste);

  const cardCollection = await axios({
    method: "GET",
    url: "https://api.pokemontcg.io/v2/cards?q=nationalPokedexNumbers:2",
