...
/**
 * One artist = one entry. Drives both the /art gallery cards and the
 * /art/[artist] collection page. Tailwind color classes are written as
 * literals (never interpolated) so the JIT compiler keeps emitting them.
 */
...
const artistQuery = (name: string): string =>
  `artist:"${name}" -set.id:mcd* supertype:"Pokémon" -subtypes:V-UNION`;

export const artists: ArtistConfig[] = [
  {
    slug: "arita",
    name: "Mitsuhiro Arita",
    metaTitle: "Mitsuhiro Arita's Art",
    subtitle: "Pokémon Card Artist",
    query: artistQuery("Mitsuhiro Arita"),
    description:
  ...
  },
  {
    slug: "akira",
    name: "Akira Egawa",
    metaTitle: "Akira Egawa's Art",
    subtitle: "Pokémon Card Artist",
    query: artistQuery("Akira Egawa"),
    description:
  ...
  },
  {
    slug: "asaka",
    name: "Asako Ito",
    metaTitle: "Asako Ito's Crocheted Pokémon Art",
    subtitle: "Pokémon Card Artist - Amigurumi Specialist",
    query: artistQuery("Asako Ito"),
    description:
  ...
  },
  {
    ...
    metaTitle: "Yoriyuki Ikegami's Art",
    subtitle: "Pokémon Card Artist",
    query: artistQuery("Yoriyuki Ikegami"),
    description:
  ...
  },
  {
    slug: "jerky",
    name: "Jerky",
    metaTitle: "Jerky's Art",
    subtitle: "Pokémon Card Artist",
    query: artistQuery("Jerky"),
    description:
  ...
  },
  {
    slug: "kantaro",
    name: "kantaro",
    metaTitle: "kantaro's Art",
    subtitle: "Pokémon Card Artist",
    query: artistQuery("kantaro"),
    description:
  ...
  },
  {
    slug: "mekayu",
    name: "Mékayu",
    metaTitle: "Mékayu's Art",
    subtitle: "Pokémon Card Artist",
    query: artistQuery("Mékayu"),
    description:
  ...
  },
  {
    ...
    metaTitle: "MINAMINAMI Take's Art",
    subtitle: "Pokémon Card Artist",
    query: artistQuery("MINAMINAMI Take"),
    description:
  ...
  },
  {
    slug: "mingo",
    name: "mingo",
    metaTitle: "mingo's Art",
    subtitle: "Pokémon Card Artist",
    query: artistQuery("mingo"),
    description:
  ...
  },
  {
    slug: "morii",
    name: "Yuka Morii",
    metaTitle: "Yuka Morii's Art",
    subtitle: "Pokémon Card Artist",
    query: artistQuery("Yuka Morii"),
    description:
  ...
  },
  {
    slug: "osare",
    name: "osare",
    metaTitle: "osare's Art",
    subtitle: "Pokémon Card Artist",
    query: artistQuery("osare"),
    description:
  ...
  },
  {
    slug: "rend",
    name: "REND",
    metaTitle: "REND's Art",
    subtitle: "Pokémon Card Artist",
    query: artistQuery("REND"),
    description:
  ...
  },
  {
    slug: "rika",
    name: "rika",
    metaTitle: "rika's Art",
    subtitle: "Pokémon Card Artist",
    query: artistQuery("rika"),
    description:
  ...
  },
  {
    slug: "rond",
    name: "Rond",
    metaTitle: "Rond's Art",
    subtitle: "Pokémon Card Artist",
    query: artistQuery("Rond"),
    description:
  ...
  },
  {
    slug: "saboteri",
    name: "Saboteri",
    metaTitle: "Saboteri's Art",
    subtitle: "Pokémon Card Artist",
    query: artistQuery("Saboteri"),
    description:
  ...
  },
  {
    slug: "kayama",
    name: "Tetsu Kayama",
    metaTitle: "Tetsu Kayama's Art",
    subtitle: "Pokémon Card Artist",
    query: artistQuery("Tetsu Kayama"),
    description:
  ...
  },
  {
    slug: "toriyufu",
    name: "toriyufu",
    metaTitle: "toriyufu's Art",
    subtitle: "Pokémon Card Artist",
    query: artistQuery("toriyufu"),
    description:
  ...
  },
  {
    slug: "uninori",
    name: "Uninori",
    metaTitle: "Uninori's Art",
    subtitle: "Pokémon Card Artist",
    query: artistQuery("Uninori"),
    description:
  ...
  },
  {
    slug: "usgmen",
    name: "USGMEN",
    metaTitle: "USGMEN's Art",
    subtitle: "Pokémon Card Artist",
    query: artistQuery("USGMEN"),
    description:
  ...
  },
  {
    ...
    metaTitle: "Shimaris Yukichi's Art",
    subtitle: "Pokémon Card Artist",
    query: artistQuery("Shimaris Yukichi"),
    description:
  ...
  },
  {
    slug: "yukihiro",
    name: "Yukihiro Tada",
    metaTitle: "Yukihiro Tada's Art",
    subtitle: "Pokémon Card Artist",
    query: artistQuery("Yukihiro Tada"),
    description:
  ...
  },
  {
    slug: "yuriko",
    name: "Yuriko Akase",
    metaTitle: "Yuriko Akase's Art",
    subtitle: "Pokémon Card Artist",
    query: artistQuery("Yuriko Akase"),
    description:
...
/** Adapt an artist into a Collection so it shares the same page + metadata path. */
export function artistCollection(artist: ArtistConfig): CollectionConfig {
  return {
    slug: artist.slug,
    basePath: "/art",
    title: artist.metaTitle,
    ...
    sources: [{ q: artist.query, orderBy: "-set.releaseDate" }],
    sort: "date",
  };
}
